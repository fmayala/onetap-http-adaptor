// Taken from https://gist.github.com/JCloudYu/38dba9ba239437755a01348967e2c2d8
...
;(() => {
  ...
  const FNV_PRIME_HIGH = 0x0100,
    FNV_PRIME_LOW = 0x0193 // 16777619 0x01000193
  ...
  function fnv1a32(input, encoding = 'utf8') {
    ...
    for (let i = 0; i < octets.length; i += 1) {
      ...
      let new_high =
        hash_low * FNV_PRIME_HIGH +
        hash_high * FNV_PRIME_LOW +
        +(new_low >>> 16)
  ...
  function fnv1a32_hex(input, encoding = 'utf8') {
    let res = fnv1a32(input, encoding)
    return res.toString(16).toUpperCase()
  }

  module.exports = { fnv1a24, fnv1a32, fnv1a32_hex }
})()
